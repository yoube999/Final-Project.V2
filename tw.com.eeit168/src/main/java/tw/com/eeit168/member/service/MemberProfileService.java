...
//更新資料後重導回會員中心
	...
	public void registerMember(JsonNode jsonNode, boolean setCustomerService) {
		try {
			...
			// 新增boolean判斷註冊是否為客服人員，true為客服人員、false為一般會員，未送的情況下即為一般會員
			if (setCustomerService) {
				newMember.setMember_level(99);
			} else {
	...
	// 确认验证代码+改密码
	public void changePasswordWithVerificationCode(String user_account, String verification_code,
	...
	public boolean updateMemberInfo(String user_account, JsonNode jsonNode) throws Exception {
		...
		if (existingMember == null) {
			throw new Exception("找不到要更新的會員資料");
		}
